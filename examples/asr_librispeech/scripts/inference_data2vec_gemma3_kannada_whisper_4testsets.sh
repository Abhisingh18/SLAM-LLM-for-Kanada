#!/bin/bash
# Inference: Whisper large-v3 encoder (OpenAI, 1280-dim, frozen) + Gemma-3-4B-IT
# + LoRA -- encoder #6.
# Copied from inference_data2vec_gemma3_kannada_transformer_4testsets.sh and
# adapted for whisper: encoder_name=whisper, encoder_dim=1280,
# input_type=mel, mel_size=128 (matches the training-time config).
...
output_dir=/speech/abhishek/output/kannada-cs-whisper-gemma3-4b-finetuned
