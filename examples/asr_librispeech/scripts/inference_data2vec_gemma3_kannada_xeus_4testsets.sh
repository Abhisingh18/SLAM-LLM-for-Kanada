#!/bin/bash
# Inference: XEUS (ESPnet E-Branchformer SSL) + Gemma-3-4B-IT + LoRA
# Copied from inference_data2vec_gemma3_kannada_4testsets.sh and adapted for
# XEUS: encoder_name=xeus, encoder_path=XEUS checkpoint, normalize=false
# (matches the training-time fix -- XEUS's own frontend expects raw,
...
# CUBLAS_STATUS_EXECUTION_FAILED), same as the training scripts.
...
output_dir=/speech/abhishek/output/kannada-cs-xeus-v2-tomson-matched-gemma3-4b-finetuned
